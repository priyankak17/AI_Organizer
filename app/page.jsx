    ...
    <div className="pk-root">
      <div className="pk-wrap">
        ...
        <div className="pk-tabs">
          {[["calendar", "calendar"], ["habits", "habits"], ["tasks", "tasks"], ["insta", "insta"], ["arbor", "neuron arbor"]].map(([id, label]) => (
        ...
        {tab === "tree" && (
          <div className="pk-card">
            <h3 className="pk-h">Study tree has grown</h3>
            <p className="pk-sub">It now lives on its own immersive page: the Neuron Arbor.</p>
            <a className="pk-btn" href="/tree" style={{ textDecoration: "none", display: "inline-block" }}>open neuron arbor →</a>
          </div>
        )}
      </div>
    </div>
